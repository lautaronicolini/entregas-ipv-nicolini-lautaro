...
onready var player_interactions = $PlayerInteractions
...
export (AudioStream) var receive_hit_sfx
...
func _receive_hit_audio():
	player_interactions.stream = receive_hit_sfx
	player_interactions.play()
